...
@CordaService
class BestOfferFinderService(private val serviceHub: AppServiceHub) : SingletonSerializeAsToken() {
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(BestOfferFinderService::class.java)
    }

    init {
        logger.info("\uD83E\uDDE9 \uD83E\uDDE9 \uD83E\uDDE9  BestOfferFinderService: " +
